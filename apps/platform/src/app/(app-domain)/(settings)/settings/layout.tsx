          ...
          <Tabs.ListContainer className="border-b border-zinc-200 dark:border-zinc-800 bg-transparent">
            <Tabs.List aria-label="Settings Options" className="p-0 flex gap-6 border-none bg-transparent">
              <Tabs.Tab
                ...
                className="relative px-1 py-3 text-sm font-medium data-[selected=true]:text-zinc-900 dark:data-[selected=true]:text-zinc-100 text-zinc-500 dark:text-zinc-400 hover:text-zinc-900 dark:hover:text-zinc-200 bg-transparent shadow-none"
              >
                <div className="flex items-center gap-2">
                  <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M19 21v-2a4 4 0 0 0-4-4H9a4 4 0 0 0-4 4v2"/><circle cx="12" cy="7" r="4"/></svg>
                  Profile
                </div>
                {mounted && <Tabs.Indicator className="bg-zinc-900 dark:bg-zinc-100 rounded-none h-0.5 bottom-0" />}
              </Tabs.Tab>
              <Tabs.Tab
                href="/settings/meta"
                id="/settings/meta"
